...
<script type="text/javascript">
	...
	//CRON JOBS
    var cron_job_list_template_url = "{{URL::asset($cron_job_pkg_prefix.'/public/themes/'.$theme.'/cron-job-pkg/cron-job/list.html')}}";
    var cron_job_form_template_url = "{{URL::asset($cron_job_pkg_prefix.'/public/themes/'.$theme.'/cron-job-pkg/cron-job/form.html')}}";
    var cron_job_view_template_url = "{{URL::asset($cron_job_pkg_prefix.'/public/themes/'.$theme.'/cron-job-pkg/cron-job/view.html')}}";
	...
	//CRON JOB REPORTS
    var cron_job_report_list_template_url = "{{URL::asset($cron_job_pkg_prefix.'/public/themes/'.$theme.'/cron-job-pkg/cron-job-report/list.html')}}";
    var cron_job_report_filter_data_url = "{{route('getCronJobReportFilter')}}";
</script>
<script type="text/javascript" src="{{URL::asset($cron_job_pkg_prefix.'/public/themes/'.$theme.'/cron-job-pkg/routes-and-components.js')}}"></script>
